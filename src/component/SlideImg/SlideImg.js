        ...
        <div className="item item--2">
            ...
            <div  className ="intro" >
                <h1 style={{fontSize:'36px', color:'white'}}>UECR</h1>
                    ...
                    <hr color="black" />
                    <figure className="wgh-slider-item-figure"><img  src={uecrIntro}  width="80%" height="250px" alt="RYSY - Traveler LP"/>
                        <figcaption className="wgh-slider-item-figure__caption"><Link to = '/aboutuecr'>
                ...
                </p></Link><span>RYSY</span></figcaption>
                    </figure>
                </div>
            ...
            <div  className ="intro" >
                ...
                <figure className="wgh-slider-item-figure">       
                    ...
                    </Link><span>RYSY</span></figcaption>
                </figure>
            </div>
